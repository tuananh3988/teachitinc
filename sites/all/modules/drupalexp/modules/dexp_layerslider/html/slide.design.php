    ...
    <fieldset class="fieldset-wrapper" style="border: none; padding:0; margin: 0 0 10px 0">
      ...
      <div id="content-type">
        ...
        <div id="content-video">
          ...
          Height: <input name="video_height" class="form-text layer-option"/><br/>
          Autoplay: <select name="video_autoplay" class="form-select layer-option">
            <option value="0">No</option>
            <option value="1">Yes</option>
          </select>
          Sound: <select name="video_volume" class="form-select layer-option">
            <option value="yes">Yes</option>
            <option value="mute">Mute</option>
          </select>
          Fullwidth: <select name="video_fullwidth" class="form-select layer-option">
            <option value="1">Yes</option>
            <option value="0">No</option>
          </select>
        </div>
      ...
      <table>
        <tr>
          <td>Top <input name="top" class="form-text layer-option"></td>
          <td>Left <input name="left" class="form-text layer-option"></td>
          <td>Link to <input name="link" class="form-text layer-option"></td>
        </tr>
        <tr>
          <td colspan="3">
            Custom CSS<br/><textarea name="custom_css" class="form-textarea layer-option"></textarea>
          </td>
        </tr>
				<tr>
          <td colspan="3">
            Custom class<br/> <input name="custom_class" class="form-text layer-option" style="max-width:400px; width:400px;"/>
          </td>
        </tr>
      </table>
    </fieldset>
